...
namespace DotNetCore.HayateOP.Tests
{
    public class AsyncPolicyReturnTests
    {
        ...
        {
            public virtual TestObject Create() { return new TestObject(); }
            public virtual ValueTask<TestObject> CreateAsync(CancellationToken cancellationToken = default) { return new ValueTask<TestObject>(new TestObject()); }
            public virtual bool OnRelease(TestObject item) { return true; }
            public virtual ValueTask<bool> OnReleaseAsync(TestObject item, CancellationToken cancellationToken = default) { return new ValueTask<bool>(true); }
            public virtual bool Validate(TestObject item) { return true; }
            public virtual void OnAcquire(TestObject item) { }
            public virtual void OnPassivate(TestObject item) { }
            public virtual ValueTask OnPassivateAsync(TestObject item, CancellationToken cancellationToken = default) { return default; }
            public virtual void OnDestroy(TestObject item) { }
            public virtual ValueTask OnDestroyAsync(TestObject item, CancellationToken cancellationToken = default) { return default; }
        }

        private sealed class GatedReturnPolicy : AsyncPolicyStub
        {
            private readonly TaskCompletionSource<bool> _passivateGate = new TaskCompletionSource<bool>(TaskCreationOptions.RunContinuationsAsynchronously);
            private readonly TaskCompletionSource<bool> _releaseGate = new TaskCompletionSource<bool>(TaskCreationOptions.RunContinuationsAsynchronously);
            ...
            public int AsyncPassivateCalls { get { return Volatile.Read(ref _asyncPassivateCalls); } }
            public int AsyncReleaseCalls { get { return Volatile.Read(ref _asyncReleaseCalls); } }
            public int SyncPassivateCalls { get { return Volatile.Read(ref _syncPassivateCalls); } }
            public int SyncReleaseCalls { get { return Volatile.Read(ref _syncReleaseCalls); } }
        ...
        private sealed class SyncOnlyPolicy : IHayateObjectPolicy<TestObject>
        {
            ...
            public int PassivateCalls { get { return Volatile.Read(ref _passivateCalls); } }
            public int ReleaseCalls { get { return Volatile.Read(ref _releaseCalls); } }

            public TestObject Create() { return new TestObject(); }
            ...
            public bool Validate(TestObject item) { return true; }
        ...
        {
            public Task<bool> IsReadyAsync(TestObject item, CancellationToken cancellationToken = default) { return Task.FromResult(true); }
            public Task PrepareAsync(TestObject item, CancellationToken cancellationToken = default) { return Task.CompletedTask; }
        }
        ...
        private sealed class SyncOnlyPool : IHayateObjectPool<TestObject>
        {
            ...
            public TestObject Acquire() { return new TestObject(); }
            public TestObject Acquire(TimeSpan timeout) { return Acquire(); }
            public Task<TestObject> AcquireAsync(CancellationToken cancellationToken = default) { return Task.FromResult(Acquire()); }
            public Task<TestObject> AcquireAsync(TimeSpan timeout, CancellationToken cancellationToken = default) { return Task.FromResult(Acquire()); }
