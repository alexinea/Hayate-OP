    ...
    public class PoolStatsOperationalMetricsTests
    {
        ...
        public void TakeSnapshot_ShouldAlsoRaiseThePeak()
        {
                ...
                .Build())
            {
                ...
                // The only read that happens while the objects are out on loan. The GetStats below runs
                // after they are all back, so a peak of 3 can only have come from here.
                pool.TakeSnapshot();
        ...
        public void Ratios_ShouldBeLiveOnAPoolThatOnlyReuses()
        {
                ...
                .Build())
            {
                ...
                // a reuse and the pool created half an object per borrow.
