...
/// </para>
/// <para>
/// The spare stack is internal state (the test project does not configure InternalsVisibleTo),
/// so the parked count is read via reflection — same approach as ShardAtomicRemovalTests.
/// </para>
/// </summary>
