...
namespace HayateOP.Tests.DI
{
    ...
    /// registered first wins and the pool resolves; since B2 <c>RegisterHayatePool</c> does the same, and
    /// its factory overload is what lets that type work through it. Without a policy of either kind the
    /// missing constructor is reported when the pool is built, naming the type.
    /// </summary>
