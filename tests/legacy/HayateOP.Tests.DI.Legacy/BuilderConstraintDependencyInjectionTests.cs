...
namespace HayateOP.Tests.DI
{
    ...
    /// registered first wins and the pool resolves; <c>RegisterHayatePool</c> owns its policy registration,
    /// so until it gains the factory overload of B2 the missing constructor is reported when the pool is
    /// built, naming the type.
    /// </summary>
