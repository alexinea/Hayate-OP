...
public class AsyncPoolDisposalTests
{
    ...
    private sealed class DisposalCounter
    {
        ...
        public int SyncDisposes => Volatile.Read(ref _syncDisposes);
        public int AsyncDisposes => Volatile.Read(ref _asyncDisposes);
    ...
    private abstract class AsyncPolicyStub : IHayateAsyncObjectPolicy<DualDisposeObject>
    {
        ...
        public virtual DualDisposeObject Create() => new(Counter);

        public virtual ValueTask<DualDisposeObject> CreateAsync(CancellationToken cancellationToken = default)
            => new(new DualDisposeObject(Counter));

        public virtual bool OnRelease(DualDisposeObject item) => true;
        public virtual ValueTask<bool> OnReleaseAsync(DualDisposeObject item, CancellationToken cancellationToken = default) => new(true);
        public virtual bool Validate(DualDisposeObject item) => true;
        public virtual void OnAcquire(DualDisposeObject item) { }
        public virtual void OnPassivate(DualDisposeObject item) { }
        public virtual ValueTask OnPassivateAsync(DualDisposeObject item, CancellationToken cancellationToken = default) => default;
        public virtual void OnDestroy(DualDisposeObject item) { }
        public virtual ValueTask OnDestroyAsync(DualDisposeObject item, CancellationToken cancellationToken = default) => default;
    }
    ...
    private sealed class GatedDestroyPolicy : AsyncPolicyStub
    {
        ...
        public int AsyncDestroyCalls => Volatile.Read(ref _asyncDestroyCalls);
        public int SyncDestroyCalls => Volatile.Read(ref _syncDestroyCalls);
    ...
    private sealed class SyncOnlyPolicy : IHayateObjectPolicy<DualDisposeObject>
    {
        ...
        public int DestroyCalls => Volatile.Read(ref _destroyCalls);

        public DualDisposeObject Create() => new(_counter);
        public bool OnRelease(DualDisposeObject item) => true;
        public bool Validate(DualDisposeObject item) => true;
    ...
    {
        public Task<bool> IsReadyAsync(DualDisposeObject item, CancellationToken cancellationToken = default) => Task.FromResult(true);
        public Task PrepareAsync(DualDisposeObject item, CancellationToken cancellationToken = default) => Task.CompletedTask;
    }
    ...
    {
        private readonly DisposalCounter _counter;
        private readonly List<DualDisposeObject> _idle = new();
        ...
        public DualDisposeObject Acquire(TimeSpan timeout) => Acquire();
        public Task<DualDisposeObject> AcquireAsync(CancellationToken cancellationToken = default) => Task.FromResult(Acquire());
        public Task<DualDisposeObject> AcquireAsync(TimeSpan timeout, CancellationToken cancellationToken = default) => Task.FromResult(Acquire());
