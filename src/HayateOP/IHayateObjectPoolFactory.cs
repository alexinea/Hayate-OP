...
//    IHayateObjectPool<T> GetPool<T>(IHayateObjectPolicy<T> policy, HayatePoolOptions options, ILogger<HayatePoolBasic<T>> logger, IHayateMetrics metrics) where T : class, new();
//    IHayateObjectPool<T> GetPool<T>(IHayateObjectPolicy<T> policy, HayatePoolOptions options, IHayateScalingStrategy scalingStrategy, ILogger<HayatePoolBasic<T>> logger, IHayateMetrics metrics) where T : class, new();
