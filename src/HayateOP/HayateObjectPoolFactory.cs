...
//    public IHayateObjectPool<T> GetPool<T>(IHayateObjectPolicy<T> policy, HayatePoolOptions options, ILogger<HayatePoolBasic<T>> logger, IHayateMetrics metrics) where T : class, new()
//    {
//        var type = typeof(T);
...
//    public IHayateObjectPool<T> GetPool<T>(IHayateObjectPolicy<T> policy, HayatePoolOptions options, IHayateScalingStrategy scalingStrategy, ILogger<HayatePoolBasic<T>> logger, IHayateMetrics metrics) where T : class, new()
//    {
//        var type = typeof(T);
...
//            opt.DefaultAcquireTimeout = newConfig.DefaultAcquireTimeout;
//            opt.UseFairMode = newConfig.UseFairMode;
...
//        ILogger<HayatePoolBasic<T>> logger = null,
//        IHayateMetrics metrics = null) where T : class, new()
//    {
//        policy = (policy ?? new DefaultHayateObjectPolicy<T>());
//        return new HayatePoolBasic<T>(policy, options, scalingStrategy, logger, metrics);
//    }
//}